...
class TriajeForm(forms.ModelForm):
    ...
    paciente = forms.ModelChoiceField(queryset=Paciente.objects.filter(estado=True), required=True, label="Paciente"),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['prioridad'].disabled = True  # La prioridad se calcula automáticamente, no debe ser editable
